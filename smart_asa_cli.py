...
Usage:
  ...
  smart_asa sendwithroyalties <asset-id> <from> <to> <amount>
                    [--reserve=<r> | --clawback=<c>]
...
def asset_send_with_royalties(
    ...
    return print(f" --- Confirmed transfer with royalties!\n")
...
def smart_asa_cli():
    ...
    elif args["sendwithroyalties"]:
        return asset_send_with_royalties(args, contract, smart_asa_app)    
    elif args["info"]:
