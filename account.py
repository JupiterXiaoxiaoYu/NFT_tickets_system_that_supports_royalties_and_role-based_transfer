...
account = Account(address='XZ47OGU6I5M33XJGHWL2DWGPXFQW4TVGCENIUEPKWMXTVP7GK2UVJECARU',algod_client=algod_client)
print(f'XZ47OGU6I5M33XJGHWL2DWGPXFQW4TVGCENIUEPKWMXTVP7GK2UVJECARU: {account.balance()}')

account = Account(address='6EBU2FYSSMVZ2VR7A4FUW3U5TEU7FX7NZ2NE2BQC76HNNAWMEPH6GAMHWM',algod_client=algod_client)
print(f'6EBU2FYSSMVZ2VR7A4FUW3U5TEU7FX7NZ2NE2BQC76HNNAWMEPH6GAMHWM: {account.balance()}')

account = Account(address='6WZNBJSLRJQ2WJCRHAEAGTH3CIYKBEUPVGFZLA32MP6UARREN2SG4ZHMLM',algod_client=algod_client)
print(f'6WZNBJSLRJQ2WJCRHAEAGTH3CIYKBEUPVGFZLA32MP6UARREN2SG4ZHMLM: {account.balance()}')
